"""
rolling_monitor_brandon.py - Project script (example).
...
DATA_FILE: Final[Path] = DATA_DIR / "system_metrics_timeseries_brandon.csv"
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "rolling_metrics_brandon.csv"
